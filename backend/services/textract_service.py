...
def extract_invoice_with_textract(s3_bucket: str, s3_key: str) -> List[Dict]:
    ...
    Returns:
        List of extracted invoice data in our schema format.
    """
    try:
        ...
        for expense_doc in response['ExpenseDocuments']:
            ...
            # Deposit can be labeled many ways
            deposit_amount = (
        ...
        print(f"DEBUG: Textract extraction complete. Found {len(results)} invoice(s).")
        return results
